    ...
    return (
      <div className="main-back">
        ...
        <div className="showcase-back">
          ...
          <p className="contents-p">I have been studying and developing web applications for two years. In most of the time I teach myself by learning from online tutorials or books. In February 2018, I joined the coding bootcamp DigitalCrafts in Houston which greatly broadened my knowledge and enhanced my coding skills. So far, I have developed dozens of web applications including Single-Page-App, Express-React app, and Python-tornado web app.</p>
